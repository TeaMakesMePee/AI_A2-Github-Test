...
void SceneBase::Init()
{
	...
	meshList[GEO_QUAD1] = MeshBuilder::GenerateQuad("quad1", Color(0, 1, 0));
	meshList[GEO_QUAD2] = MeshBuilder::GenerateQuad("quad1", Color(1, 1, 0));
	meshList[GEO_QUAD3] = MeshBuilder::GenerateQuad("quad1", Color(0, 0, 1));
	meshList[GEO_QUAD4] = MeshBuilder::GenerateQuad("quad1", Color(0.1, 0.1, 0.1));
	...
	meshList[GEO_KNIGHT] = MeshBuilder::GenerateQuad("chessboard", Color(1, 1, 1));
	...
	meshList[GEO_CHESSBOARD2] = MeshBuilder::GenerateQuad("grid", Color(1, 1, 1), 1.f);
	meshList[GEO_CHESSBOARD2]->textureID = LoadTGA("Image//grid.tga");

	meshList[GEO_WHITEQUAD] = MeshBuilder::GenerateQuad("grid", Color(1, 1, 1), 1.f);
	meshList[GEO_BLACKQUAD] = MeshBuilder::GenerateQuad("grid", Color(0, 0, 0), 1.f);
	meshList[GEO_GREYQUAD] = MeshBuilder::GenerateQuad("grid", Color(0.5f, 0.5f, 0.5f), 1.f);

	meshList[GEO_REVERSI4] = MeshBuilder::GenerateQuad("reversi4", Color(0.5f, 0.5f, 0.5f), 1.f);
	meshList[GEO_REVERSI4]->textureID = LoadTGA("Image//reversi4x4.tga");

	meshList[GEO_REVERSI] = MeshBuilder::GenerateQuad("reversi", Color(0.5f, 0.5f, 0.5f), 1.f);
	meshList[GEO_REVERSI]->textureID = LoadTGA("Image//reversi.tga");

	meshList[GEO_WHITE] = MeshBuilder::GenerateQuad("reversi", Color(0.5f, 0.5f, 0.5f), 1.f);
